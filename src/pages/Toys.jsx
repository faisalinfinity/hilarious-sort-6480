...
const Toys = () => {
 ...
 useEffect(()=>{
  ...
  if(products?.length===0||location){
    ...
    dispatch(getDataToys(searchValue,getProductParam))
  }
      ...
      <Drawer placement={placement} onClose={onClose} isOpen={isOpen}>
        ...
        <DrawerContent>
          ...
          >
            ...
            <Checkbox value={"wrestling"} colorScheme="green">
              Wrestling
              </Checkbox>
              <Checkbox value={"plane"} colorScheme="green">
              Plane
              </Checkbox>
             
              <Checkbox value={"car"} colorScheme="green">
              Car
              </Checkbox>
              
             
              <Checkbox value={"card"} colorScheme="green">
              Card
              </Checkbox>
              <Checkbox value={"train"} colorScheme="green">
              Train
              </Checkbox>
            </Stack>
          </CheckboxGroup>
