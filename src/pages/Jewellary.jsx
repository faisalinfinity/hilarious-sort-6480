...
import {  getDataJewellary } from "../redux/products/productAction";
...
const Jewellary = () => {
 ...
 const { isOpen, onOpen, onClose } = useDisclosure()
  ...
  useEffect(() => {
    ...
    if (searchValue !== "") {
      ...
      dispatch(getDataJewellary(searchValue));
    }
  }, [location]);
 ...
 useEffect(()=>{
  ...
  if(products?.length===0||location){
    ...
    dispatch(getDataJewellary(searchValue,getProductParam))
  }
